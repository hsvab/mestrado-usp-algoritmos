...
modelo_1 <- lm(DURACAO ~ PRESENCA_FILH_ate4, data=od_reg_1)
summary(modelo_1)
...
modelo_2 <- lm(DURACAO ~ PRESENCA_FILH_5a9, data=od_reg_2)
summary(modelo_2)
...
modelo_3 <- lm(DURACAO ~ PRESENCA_FILH_10a14, data=od_reg_3)
summary(modelo_3)
...
modelo_4 <- lm(DURACAO ~ PRESENCA_FILH_15a19, data=od_reg_4)
summary(modelo_4)
...
modelo_5 <- lm(DURACAO ~ PRESENCA_IDOSO_60_70, data=od_reg_5)
summary(modelo_5)
...
modelo_6 <- lm(DURACAO ~ PRESENCA_IDOSO_70 , data=od_reg_6)
summary(modelo_6)
...
modelo_7 <- lm(DURACAO ~ PRESENCA_FILH_ate4 + PRESENCA_FILH_5a9, data=od_reg_7)
summary(modelo_7)
...
modelo_8 <- lm(DURACAO ~ PRESENCA_FILH_ate4 + PRESENCA_FILH_5a9 + 
...
modelo_9 <- lm(DURACAO ~ PRESENCA_FILH_ate4 + PRESENCA_FILH_5a9 + 
...
modelo_10 <- lm(DURACAO ~ PRESENCA_IDOSO_60_70 + PRESENCA_IDOSO_70, data=od_reg_10)
summary(modelo_10)
...
# Regressão linear múltipla de DURACAO de od_reg com as faixas etárias
# Avaliação somente do efeito da presença de idosos com mais de 60 anos
modelo_11 <- lm(DURACAO ~ PRESENCA_IDOSO_60_70 + PRESENCA_IDOSO_70, data=od_reg_11)
summary(modelo_11)
...
modelo_12 <- lm(DURACAO ~ PRESENCA_AUTO, data=od_reg_12)
summary(modelo_12)
