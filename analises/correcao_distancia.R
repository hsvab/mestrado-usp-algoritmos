...
matriz77 <- fread(file.path(.dirAlgoritmos,
                              'CSVs-auxiliares/matriz_distancias_1977.csv'),
                  header=TRUE, sep=',', dec='.', data.table = FALSE)
matriz87 <- fread(file.path(.dirAlgoritmos,
                              'CSVs-auxiliares/matriz_distancias_1987.csv'),
                  header=TRUE, sep=',', dec='.', data.table = FALSE)
matriz97 <- fread(file.path(.dirAlgoritmos,
                              'CSVs-auxiliares/matriz_distancias_1997.csv'),
                  header=TRUE, sep=',', dec='.', data.table = FALSE)
