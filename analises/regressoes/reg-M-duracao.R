...
# pessoa (F_PESS=1)
# mulher (SEXO==2)
# pessoa responsável pela família (SIT_FAM==2)
od_reg_1 <- od %>% filter(SEXO==2, F_PESS==1, SIT_FAM==2)
...
# mulher (SEXO==2)
# pessoa responsável pela família (SIT_FAM==2)
od_reg_3 <- od %>% filter(SEXO==2, F_PESS==1, SIT_FAM==2)
...
# mulher (SEXO==2)
# pessoa responsável pela família (SIT_FAM==2)
od_reg_4 <- od %>% filter(SEXO==2, F_PESS==1, SIT_FAM==2)
...
# mulher (SEXO==2)
# pessoa responsável pela família (SIT_FAM==2)
od_reg_5 <- od %>% filter(SEXO==2, F_PESS==1, SIT_FAM==2)
...
# mulher (SEXO==2)
# pessoa responsável pela família (SIT_FAM==2)
od_reg_6 <- od %>% filter(SEXO==2, F_PESS==1, SIT_FAM==2)
...
# mulher (SEXO==2)
# pessoa responsável pela família (SIT_FAM==2)
od_reg_7 <- od %>% filter(SEXO==2, F_PESS==1, SIT_FAM==2)
...
# mulher (SEXO==2)
# pessoa responsável pela família (SIT_FAM==2)
od_reg_8 <- od %>% filter(SEXO==2, F_PESS==1, SIT_FAM==2)
...
# mulher (SEXO==2)
# pessoa responsável pela família (SIT_FAM==2)
od_reg_9 <- od %>% filter(SEXO==2, F_PESS==1, SIT_FAM==2)
...
# mulher (SEXO==2)
# pessoa responsável pela família (SIT_FAM==2)
od_reg_10 <- od %>% filter(SEXO==2, F_PESS==1, SIT_FAM==2)
...
od_reg_11 <- od %>% filter(SEXO==2, F_PESS==1, SIT_FAM==2, FAIXA_ETARIA<12)
...
# mulher (SEXO==2)
# pessoa responsável pela família (SIT_FAM==2)
od_reg_12 <- od %>% filter(SEXO==2, F_PESS==1, SIT_FAM==2)
