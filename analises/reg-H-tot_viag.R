...
od_reg_1 <- od %>% filter(SEXO==1, F_PESS==1, SIT_FAM==1)
...
modelo_1 <- lm(TOT_VIAG ~ PRESENCA_FILH_ate4, data=od_reg_1)
summary(modelo_1)
...
# homem (SEXO==1)
# pessoa responsável pela família (SIT_FAM==1)
od_reg_2 <- od %>% filter(SEXO==1, F_PESS==1, SIT_FAM==1)

# Regressão linear múltipla de TOT_VIAG de od_reg com as faixas etárias
# Avaliação somente do efeito da presença de filhos entre 5 e 9 anos
modelo_2 <- lm(TOT_VIAG ~ PRESENCA_FILH_5a9, data=od_reg_2)
summary(modelo_2)
...
# homem (SEXO==1)
# pessoa responsável pela família (SIT_FAM==1)
od_reg_3 <- od %>% filter(SEXO==1, F_PESS==1, SIT_FAM==1)

# Regressão linear múltipla de TOT_VIAG de od_reg com as faixas etárias
# Avaliação somente do efeito da presença de filhos entre 10 e 14 anos
modelo_3 <- lm(TOT_VIAG ~ PRESENCA_FILH_10a14, data=od_reg_3)
summary(modelo_3)
...
# homem (SEXO==1)
# pessoa responsável pela família (SIT_FAM==1)
od_reg_4 <- od %>% filter(SEXO==1, F_PESS==1, SIT_FAM==1)

# Regressão linear múltipla de TOT_VIAG de od_reg com as faixas etárias
# Avaliação somente do efeito da presença de filhos entre 15 e 19 anos
modelo_4 <- lm(TOT_VIAG ~ PRESENCA_FILH_15a19, data=od_reg_4)
summary(modelo_4)
...
# homem (SEXO==1)
# pessoa responsável pela família (SIT_FAM==1)
od_reg_5 <- od %>% filter(SEXO==1, F_PESS==1, SIT_FAM==1)

# Regressão linear múltipla de TOT_VIAG de od_reg com as faixas etárias
# Avaliação somente do efeito da presença de idosos entre 60 e 70 anos
modelo_5 <- lm(TOT_VIAG ~ PRESENCA_IDOSO_60_70, data=od_reg_5)
summary(modelo_5)
...
# homem (SEXO==1)
# pessoa responsável pela família (SIT_FAM==1)
od_reg_6 <- od %>% filter(SEXO==1, F_PESS==1, SIT_FAM==1)

# Regressão linear múltipla de TOT_VIAG de od_reg com as faixas etárias
# Avaliação somente do efeito da presença de idosos com mais de 70 anos
modelo_6 <- lm(TOT_VIAG ~ PRESENCA_IDOSO_70 , data=od_reg_6)
summary(modelo_6)
...
# homem (SEXO==1)
# pessoa responsável pela família (SIT_FAM==1)
od_reg_7 <- od %>% filter(SEXO==1, F_PESS==1, SIT_FAM==1)

# Regressão linear múltipla de TOT_VIAG de od_reg com as faixas etárias
# Avaliação somente do efeito da presença de filhos até 9 anos
modelo_7 <- lm(TOT_VIAG ~ PRESENCA_FILH_ate4 + PRESENCA_FILH_5a9, data=od_reg_7)
summary(modelo_7)
...
# homem (SEXO==1)
# pessoa responsável pela família (SIT_FAM==1)
od_reg_8 <- od %>% filter(SEXO==1, F_PESS==1, SIT_FAM==1)

# Regressão linear múltipla de TOT_VIAG de od_reg com as faixas etárias
# Avaliação somente do efeito da presença de filhos até 14 anos
modelo_8 <- lm(TOT_VIAG ~ PRESENCA_FILH_ate4 + PRESENCA_FILH_5a9 + 
                 PRESENCA_FILH_10a14, data=od_reg_8)
summary(modelo_8)
...
# homem (SEXO==1)
# pessoa responsável pela família (SIT_FAM==1)
od_reg_9 <- od %>% filter(SEXO==1, F_PESS==1, SIT_FAM==1)

# Regressão linear múltipla de TOT_VIAG de od_reg com as faixas etárias
# Avaliação somente do efeito da presença de filhos até 19 anos
modelo_9 <- lm(TOT_VIAG ~ PRESENCA_FILH_ate4 + PRESENCA_FILH_5a9 + 
                 PRESENCA_FILH_10a14 + PRESENCA_FILH_15a19, data=od_reg_9)
summary(modelo_9)
...
# homem (SEXO==1)
# pessoa responsável pela família (SIT_FAM==1)
od_reg_10 <- od %>% filter(SEXO==1, F_PESS==1, SIT_FAM==1)

# Regressão linear múltipla de TOT_VIAG de od_reg com as faixas etárias
# Avaliação somente do efeito da presença de idosos com mais de 60 anos
modelo_10 <- lm(TOT_VIAG ~ PRESENCA_IDOSO_60_70 + PRESENCA_IDOSO_70, data=od_reg_10)
summary(modelo_10)
...
od_reg_11 <- od %>% filter(SEXO==1, F_PESS==1, SIT_FAM==1, FAIXA_ETARIA<12)

# Regressão linear múltipla de TOT_VIAG de od_reg com as faixas etárias
# Avaliação somente do efeito da presença de idosos com mais de 60 anos
modelo_11 <- lm(TOT_VIAG ~ PRESENCA_IDOSO_60_70 + PRESENCA_IDOSO_70, data=od_reg_11)
summary(modelo_11)
...
# homem (SEXO==1)
# pessoa responsável pela família (SIT_FAM==1)
od_reg_12 <- od %>% filter(SEXO==1, F_PESS==1, SIT_FAM==1)

# Regressão linear múltipla de TOT_VIAG de od_reg com as faixas etárias
# Avaliação somente do efeito da presença de automóvel na família
modelo_12 <- lm(TOT_VIAG ~ PRESENCA_AUTO, data=od_reg_12)
summary(modelo_12)
