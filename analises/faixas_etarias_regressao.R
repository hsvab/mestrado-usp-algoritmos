# Criando novas variaveis com marcação da FX etária, para posterior regressão linear
...
# Regressão linear Múltipla com das faixas etárias
modelo_1 <- lm(TOT_VIAG ~ FX_ET_0 + FX_ET_1 + FX_ET_2 + FX_ET_3 + FX_ET_4 + FX_ET_5 + FX_ET_6 + FX_ET_7 +
                 ...
                 FX_ET_16 + FX_ET_17 + FX_ET_18 + FX_ET_19 + FX_ET_20, data=od)
summary(modelo_1)