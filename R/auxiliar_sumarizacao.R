local({
    ...
    resumo.resultados <-  function(DF=od,
      ...
      geral <- .mestrado.resumo.resultados.gerais(
                                    DF = DF,
      ...
      viagens <- .mestrado.resumo.resultados.viagens(
                                    DF = DF,
                                    AGRUPA_POR = AGRUPA_POR,
                                    IMPRIME = F,
                                    RETORNA = T,
      ...
      pessoas <- .mestrado.resumo.resultados.pessoas(
                                    DF = DF,
                                    AGRUPA_POR = AGRUPA_POR,
                                    IMPRIME = F,
                                    RETORNA = T)
      ...
      familias <- .mestrado.resumo.resultados.familias(
                                    DF = DF,
                                    AGRUPA_POR = AGRUPA_POR,
                                    IMPRIME = F,
                                    RETORNA = T)
    ...
    assign(".mestrado.resumo.resultados.gerais", resumo.resultados.gerais,
           envir=globalenv())

    assign(".mestrado.resumo.resultados.viagens", resumo.resultados.viagens,
           envir=globalenv())

    assign(".mestrado.resumo.resultados.pessoas", resumo.resultados.pessoas,
           envir=globalenv())
